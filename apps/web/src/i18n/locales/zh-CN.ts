const zhCN = {
  ...
  "models.byok.addModelPlaceholder": "搜索或输入模型 ID...",
  "models.byok.availableModels": "可用模型",
  "models.byok.searchEmpty": "没有匹配的模型",
  "models.byok.addCustomModelHint": "将“{{modelId}}”添加为自定义模型",
  "models.byok.addModel": "添加",
  "models.byok.testModel": "测试模型",
  "models.byok.testAvailable": "可用",
  "models.byok.testUnavailable": "不可用",
  "models.byok.testFailed": "模型 {{modelId}} 测试失败：{{error}}",
  "models.byok.removeModel": "移除模型",
