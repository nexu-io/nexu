...
| `openclaw-runtime-boundary.md` | Boundary and ownership rules for `packages/openclaw-runtime` |
| `openclaw-startup-crash-analysis.md` | Gateway startup crash scenarios and mitigations |
