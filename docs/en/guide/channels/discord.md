...
![Discord Applications page](/assets/discord/step1-applications.png)

2. Enter the application name and click "Create".

![Create application](/assets/discord/step1-create-app.png)

3. On the "General Information" page, copy and save:
   - **Application ID**

![Get Application ID](/assets/discord/step1-general-info.png)

4. In the left menu, go to "Bot", click "Reset Token" to generate a Bot Token, and copy it:
   - **Bot Token**

![Generate Bot Token](/assets/discord/step3-bot-token.png)
...
![Add credentials in nexu](/assets/discord/step2-nexu-connect.png)
...
![Enable Message Content Intent](/assets/discord/step4-intents.png)

2. In the left menu, go to "OAuth2" → "URL Generator" and select Scopes:
   - `bot`
   - `applications.commands`

![Select Scopes](/assets/discord/step5-scopes.png)
...
![Select Bot Permissions](/assets/discord/step5-permissions.png)

4. Copy the generated URL at the bottom of the page and open it in your browser.

![Copy generated URL](/assets/discord/step5-generated-url.png)

5. Select your server and click "Continue".

![Select server](/assets/discord/step3-select-server.png)

6. Confirm the permissions and click "Authorize" to add the bot.

![Authorize bot](/assets/discord/step3-authorize.png)

## Step 4: Test

Once connected, click "Chat" in the nexu client to jump to Discord and chat with your bot 🎉

![Discord connected](/assets/discord/step4-connected.png)
